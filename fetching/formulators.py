...
import fetching.stream_receiving
from fetching.data_models import TsSegment


class PowernetFormulator(fetching.formulator.M3u8Formulator):

    def __init__(self, config: fetching.stream_receiving.M3u8Watcher.Config):
